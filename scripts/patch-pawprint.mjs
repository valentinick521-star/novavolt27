...
const HEADLINE = "This Breakthrough Longevity Formula Is Helping Senior Dogs with Dementia Feel Like Themselves Again";
...
mustReplace(/<div class="header-tagline">\s*Practical guides for better pet care decisions\s*<\/div>/, "", "header tagline");
...
mustReplace(/<h1>Your Dog’s Dementia Isn’t Just “Old Age\.” Here’s What Most Cognitive Supplements Miss<\/h1>/, `<h1>${HEADLINE}</h1>`, "article headline");
...
for (const marker of [HEADLINE,'id="senior-dogs"','id="approaches"','id="cellular-energy"','id="ninety-day"','class="site-logo"','data-preserved-gtm','CHECK PAWPRINT PROTOCOL AVAILABILITY']) {
