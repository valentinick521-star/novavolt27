...
const logo =
  '<a class="site-logo-link" href="/" aria-label="National Consumer Review home"><img class="site-logo" src="https://cdn.builder.io/api/v1/image/assets%2Fe9508f1e32b34813a11957a3abee3959%2Fbadcc4098d254fadb81b2c01ff7bb98c?format=webp&width=360" alt="National Consumer Review" width="420" height="67" decoding="async" /></a>';
...
const favicon =
  '<link rel="icon" type="image/webp" href="https://cdn.builder.io/api/v1/image/assets%2Fe9508f1e32b34813a11957a3abee3959%2Fe1efdedf37544e5982cb5ee6c0980a0e?format=webp&width=64&height=64" />';
...
html = html.replace(
  ...
  '<meta name="description" content="A practical advertorial for senior-dog owners comparing traditional cognitive support with a cellular-energy approach to healthy aging." />',
);
mustReplace(
...
mustReplace(
  /<div class="header-tagline">\s*Practical guides for better pet care decisions\s*<\/div>/,
  "",
  "header tagline",
);
mustReplace(
...
mustReplace(
  /<h1>Your Dog’s Dementia Isn’t Just “Old Age\.” Here’s What Most Cognitive Supplements Miss<\/h1>/,
  `<h1>${HEADLINE}</h1>`,
  "article headline",
);

html = html.replace(
  '<div class="footer-brand">Pet Wellness Report</div>',
  '<div class="footer-brand">National Consumer Review</div>',
);
html = html.replace(
  /<div class="copyright">[\s\S]*?<\/div>\s*<\/footer>/,
  '<div class="copyright">© 2026 NationalConsumerReview.com. All rights reserved. This page is an advertorial and general educational content, not veterinary advice.</div>\n</footer>',
);
...
if (html.includes("Practical guides for better pet care decisions"))
  throw new Error("Header tagline remained");
if (html.includes("A Fair Comparison of the Three Main Approaches"))
  throw new Error("Old buyer-guide copy remained");

fs.writeFileSync(filePath, html);
console.log(
  "Built PawPrint dementia advertorial in the existing National Consumer Review template",
);
